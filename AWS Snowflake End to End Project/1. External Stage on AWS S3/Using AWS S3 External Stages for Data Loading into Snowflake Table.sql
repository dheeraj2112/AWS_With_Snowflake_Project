...
--13 Selecting the file contents (1 file as of now)

SELECT $1,$2,$3,$4,$5,TO_TIMESTAMP(TO_DATE($6,'DD-MON-YY')) as computed ,$7,$8,$9, $10  FROM @DJ_WORLD.DJ.DJ_S3_STAGE

--14 Provide the required priviliges to the roles, if you face access issues for the role that you are using.
