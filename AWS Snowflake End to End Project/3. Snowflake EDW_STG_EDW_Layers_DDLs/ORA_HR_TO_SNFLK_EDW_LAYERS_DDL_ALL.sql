--Creating the database and schemas as required by Snowflake or any thrid party tools for EDW_STG and EDW Layers DDLs.
...
--Additonal surrogate keys in the EDW tables using AUTOINCREMENT or IDENTITY options
...
--EDW_EXTR EMPLOYEE_DETAILS VIEW for Reporting and Visualizations
